...
class CMAPG:
    ...
    def update(
        ...
        # Combine: redistribute GAE advantage by counterfactual weights
        cf_weights = torch.softmax(cf_adv_flat, dim=-1)  # (B*T, n_agents)
        advantages_flat = gae_adv_flat.unsqueeze(-1) * cf_weights  # (B*T, n_agents)
